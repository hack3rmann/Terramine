...
unsigned char* load_texture_bytes(
...
Texture* load_texture(char const* file) {
    int width, height;
...
GLuint LoadGLTextures(char const* filename, int* width, int* height) {
    /* Status indicator */
    GLuint texture = 0;
...
Texture* load_textureRGB(char const* file) {
    int width, height;
...
GLuint LoadGLTexturesRGB(char const* filename, int* width, int* height) {
    /* Status indicator */
    GLuint texture = 0;
...
Texture* load_texture_NO_MIPMAP_LINEAR(char const* file) {
    int width, height;
...
GLuint LoadGLTextures_NO_MIPMAP_LINEAR(
    char const* filename, int* width, int* height
) {
    /* Status indicator */
    GLuint texture = 0;
