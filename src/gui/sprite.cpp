...
auto GuiObject::add_gui_rect(Mesh<Vertex>* mesh, glm::vec2 pos, glm::vec2 size)
    -> void {
...
, size{size} {
    ...
    Sprite::add_gui_rect(
        &this->mesh, pos, glm::vec2{aspect_ratio * size, size}
    );
}

auto Sprite::render(ShaderProgram const& shader, glm::uvec2 viewport_size) const
    -> void {
