    ...
    for (int z = 0; z < CHUNK_D; z++) {
        for (int x = 0; x < CHUNK_W; x++) {
            ...
            float height = glm::perlin(
                glm::vec3(real_x * 0.0026125f, real_z * 0.0026125f, 0.0f)
            );
            height += glm::perlin(glm::vec3(
                          real_x * 0.006125f, real_z * 0.006125f, 0.0f
                      )) *
                      0.5f;
            height += glm::perlin(glm::vec3(
                          real_x * 0.018125f, real_z * 0.018125f, 0.0f
                      )) *
                      0.25f;
            height += glm::perlin(glm::vec3(
                          real_x * 0.038125f, real_z * 0.038125f, 0.0f
                      )) *
                      0.175f;
