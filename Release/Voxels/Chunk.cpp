...
Chunk::Chunk(int xpos, int ypos, int zpos) : x(xpos), y(ypos), z(zpos) {
	...
	//			int id = glm::perlin(glm::vec3(real_x * 0.0125f, real_y * 0.0125f, real_z * 0.0125f)) > 0.1f;// (glm::perlin(glm::vec3(real_x * 0.006, real_y * 0.036, real_z * 0.005)) * glm::perlin(glm::vec3(real_x * 0.006, real_y * 0.036, real_z * 0.005))) * 10.f + 10.f;
	//			//int id = real_y <= (glm::perlin(glm::vec3(real_x * 0.006, real_y * 0.036, real_z * 0.005)) * glm::perlin(glm::vec3(real_x * 0.006, real_y * 0.036, real_z * 0.005))) * 10.f + 9.f ? 2 : 0;
	//			if (real_y <= 2) id = 2;
